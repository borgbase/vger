...
use vger_storage::StorageConfig;
...
///
/// Convenience wrapper around [`vger_storage::backend_from_config`] that
/// accepts a [`RepositoryConfig`] directly.
pub fn backend_from_config(
    cfg: &RepositoryConfig,
) -> Result<Box<dyn vger_storage::StorageBackend>> {
    vger_storage::backend_from_config(&storage_config_from_repo(cfg))
}
